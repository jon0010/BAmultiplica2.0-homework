...
*/`)}
${chalk_1.default.green('target')}: (dependencyName, [{ semver, version, operator, major, minor, patch, release, build }]) ${chalk_1.default.cyan('=>')} {
...
const cliOptions = [
    ...
    },
    {
        ...
        short: 't',
        arg: 'value',
        description: `Determines the version to upgrade to: ${Target_1.supportedVersionTargets.join(', ')}, @[tag], or [function]. (default: latest)`,
        help: extendedHelpTarget,
        // eslint-disable-next-line no-template-curly-in-string
        type: `${Target_1.supportedVersionTargets.map(s => `'${s}'`).join(' | ')} | ${'`@${string}`'} | TargetFunction`,
    },
    {
        long: 'timeout',
        arg: 'ms',
